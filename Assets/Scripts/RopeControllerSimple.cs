...
public class RopeControllerSimple : MonoBehaviour
{
    ...
    private readonly float minRopeLength = 0.05f;
    private readonly float maxRopeLength = 1f;
    //Mass of what the rope is carrying
    private readonly float loadMass = 250f;
    //How fast we can add more/less rope
    private readonly float winchSpeed = 0.5f;
