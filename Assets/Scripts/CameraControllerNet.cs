...
public class CameraControllerNet : MonoBehaviour
{
    ...
    private DrivebaseControllerNet drivebaseControllerNet;
    ...
    void Start()
    {
        ...
        drivebaseControllerNet = this.transform.parent.GetComponent<DrivebaseControllerNet>();
        robotCamera = gameObject.GetComponent<Camera>();
        audioListener = gameObject.GetComponent<AudioListener>();
    }

    void Update()
    {
        if (drivebaseControllerNet is null)
        {
            Destroy(this.gameObject);
        }

        if (robotCamera.enabled && !drivebaseControllerNet.isLocalPlayer)
        {
